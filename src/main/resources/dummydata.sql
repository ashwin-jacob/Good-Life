...
INSERT INTO GOODLIFE.MULTI_CHOICE_LIST
(MC_LIST_ID,SUBCHAPID,TITLE,DESCR,ORDER_ID,PUBLISHED,GRADED)
VALUES(2,2,'Multi List Title','Multi List Description',1,TRUE,TRUE);
INSERT INTO GOODLIFE.MULTI_CHOICE_LIST
(MC_LIST_ID,SUBCHAPID,TITLE,DESCR,ORDER_ID,PUBLISHED,GRADED)
VALUES(3,2,'Multi List Title','Multi List Description',2,FALSE,FALSE);
...
(SAQID,SUBCHAPID,USR_ANS,USERID,APRVD,SUBMITTED)
VALUES(1,5,'This is my answer.',13,TRUE,TRUE);
INSERT INTO GOODLIFE.SHORT_ANS_USER_ANS
(SAQID,SUBCHAPID,USR_ANS,USERID,APRVD,SUBMITTED)
VALUES(2,5,'This is my second answer.',13,TRUE,TRUE);
